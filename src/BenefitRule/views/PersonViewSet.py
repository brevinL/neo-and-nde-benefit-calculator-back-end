...
from BenefitRule.models import BenefitRule, Relationship, Record, Person
...
class PersonViewSet(viewsets.ModelViewSet):
	...
	def get_record(self, request, pk=None): # given an inital record -> applied benefit rules to record -> update record
		...
		record = Record.objects.calculate_retirement_record(benefit_rules=benefit_rules, respondent=person)
		...
		for relationship in respondent_married_relationships:
			...
			record = Record.objects.calculate_survivor_benefits(benefit_rules=benefit_rules, respondent=person, beneficiary_record=record, spousal_beneficiary_record=spouse_record)
			...
			spouse_record = Record.objects.calculate_survivor_benefits(benefit_rules=benefit_rules, respondent=person, beneficiary_record=spouse_record, spousal_beneficiary_record=record)
	...
	def get_detail_record(self, request, pk=None):
		...
		detail_record = DetailRecord.objects.calculate_retirement_record(benefit_rules=benefit_rules, respondent=person, beneficiary_record=record)
		...
		for relationship in respondent_married_relationships:
			...
			detail_record = DetailRecord.objects.calculate_survivor_benefits(benefit_rules=benefit_rules, respondent=person, beneficiary_record=record, spousal_beneficiary_record=spouse_record, detail_record=detail_record)
			...
			spouse_detail_record = DetailRecord.objects.calculate_survivor_benefits(benefit_rules=benefit_rules, respondent=person, beneficiary_record=spouse_record, spousal_beneficiary_record=record, detail_record=spouse_detail_record)
