...
class Record(Record):
	...
	def calculate_retirement_record(self, benefit_rules, person):
		...
		normal_retirement_age = self.calculate_normal_retirement_age(
			...
			year_of_birth=person.year_of_birth)
		annual_covered_earnings = self.calculate_annual_covered_earnings(earnings=person.annual_covered_earnings)
		...
		annual_non_covered_earnings = self.calculate_annual_non_covered_earnings(earnings=person.annual_non_covered_earnings)
		...
		monthly_non_covered_pension = self.calculate_monthly_non_covered_pension(
			...
			fraction_of_non_covered_aime_to_non_covered_pension=person.fraction_of_non_covered_aime_to_non_covered_pension)
		...
		delay_retirement_credit = self.calculate_delay_retirement_credit(
			...
			delay_retirement_credit=person.delay_retirement_credit)
		...
		early_retirement_reduction = self.calculate_early_retirement_reduction(
			...
			early_retirement_reduction=person.early_retirement_reduction)
	...
	def calculate_survivor_benefits(self, benefit_rules, person, beneficiary_record, spousal_beneficiary_record):
		survivor_early_retirement_reduction = person.survivor_early_retirement_reduction
